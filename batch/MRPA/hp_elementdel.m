function [hp,hpind,invind] = hp_elementdel(hp,hpind,delsq,invind,hpsize)
%delete arbitary element in heaps
...
if b_inv
    %update invind
    invind(hpind(delsq))= delsq;
end
l = l-1;
% heaps = heaps(1:l);
% heapind = heapind(1:l);
%as heap always 1*n, give heapsize to know the endposition
